...
public class Fog : ScriptableRendererFeature
{
	...
	{
		private RenderTargetIdentifier _customRenderTargetIdentifier;
		...
		{
			mat = new Material(Shader.Find("PostProcessing/Fog"));
		}
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			cmd.Blit(Source, BuiltinRenderTextureType.CurrentActive, mat);
